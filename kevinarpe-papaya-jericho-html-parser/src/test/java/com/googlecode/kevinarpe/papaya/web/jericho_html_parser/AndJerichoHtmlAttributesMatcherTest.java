 ...
 */
public class AndJerichoHtmlAttributesMatcherTest
extends AbstractJerichoHtmlAttributesMatcherImpTest {
    ...
    public void pass() {
        ...
        final JerichoHtmlAttributesMatcher m_m2 = matcher.and(matcher2);
        final JerichoHtmlAttributesMatcher m2_m = matcher2.and(matcher);
        final JerichoHtmlAttributesMatcher mb_m2b = matcherb.and(matcher2b);
        final JerichoHtmlAttributesMatcher m2b_mb = matcher2b.and(matcherb);
        ...
        Assert.assertEquals(m_m2.toString(), "(value=\"\") and (type=\"text\")");
        Assert.assertEquals(m2_m.toString(), "(type=\"text\") and (value=\"\")");
        Assert.assertEquals(mb_m2b.toString(), "(value=\"\") and (type=\"text\")");
        Assert.assertEquals(m2b_mb.toString(), "(type=\"text\") and (value=\"\")");
    }
}
