 ...
 *
 * @see JerichoHtmlAttributesMatcher#and(JerichoHtmlAttributesMatcher)
 */
@FullyTested
public final class AndJerichoHtmlAttributesMatcher
extends AbstractJerichoHtmlAttributesMatcher {
     ...
     * @see JerichoHtmlAttributesMatcher#and(JerichoHtmlAttributesMatcher)
     */
    public AndJerichoHtmlAttributesMatcher(JerichoHtmlAttributesMatcher left,
    ...
    isEqual(Object obj) {
        ...
        final AndJerichoHtmlAttributesMatcher other = (AndJerichoHtmlAttributesMatcher) obj;
