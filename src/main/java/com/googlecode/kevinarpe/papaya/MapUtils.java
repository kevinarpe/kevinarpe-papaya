...
public final class MapUtils {
     ...
     * @throws NullPointerException if {@code keyAndValueList} is {@code null}
     * @throws IllegalArgumentException if {@code keyAndValueList.size()} is not even,
     *         <br>or a key is not assignable to type defined by {@code keyClass},
     *         <br>or a value is not assignable to type defined by {@code valueClass},
     *         <br>or a duplicate key exists
     ...
     * @throws NullPointerException if {@code keyAndValueList} is {@code null}
     * @throws IllegalArgumentException if {@code keyAndValueList.size()} is not even,
     *         <br>or a key cannot be cast to type {@code TKey},
     *         <br>or a value cannot be cast to type {@code TValue},
     *         <br>or a duplicate key exists
     ...
     * @throws NullPointerException if {@code map} or {@code keyAndValueList} is {@code null}
     * @throws IllegalArgumentException if {@code keyAndValueList.size()} is not even,
     *         <br>or a key cannot be cast to type {@code TKey},
     *         <br>or a value cannot be cast to type {@code TValue},
     *         <br>or a duplicate key exists
     ...
     *        List may be empty.
     * @return new HashMap reference with key-value pairs inserted
     * @throws NullPointerException if {@code keyList} or {@code valueList} is {@code null}
     ...
     *        List may be empty.
     * @return input reference
     * @throws NullPointerException if {@code map}, {@code keyList}, or {@code valueList} is {@code null}
     * @throws IllegalArgumentException if {@code keyList.size() != valueList.size()},
     *         <br>or a key cannot be cast to type {@code TKey},
     *         <br>or a value cannot be cast to type {@code TValue},
     *         <br>or a duplicate key exists
