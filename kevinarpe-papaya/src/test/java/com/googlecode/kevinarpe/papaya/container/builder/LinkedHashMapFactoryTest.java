...
public class LinkedHashMapFactoryTest {
    ...
    private LinkedHashMapFactory<String, Integer> classUnderTest;

    @BeforeMethod
    public void beforeEachTestMethod() {
        classUnderTest = LinkedHashMapFactory.create();
    }

    ////////////////////////////////////////////////////////////////////////////////////////////////
    // LinkedHashMapFactory.create()
    //

    @Test
    public void create_Pass() {
        LinkedHashMapFactory<String, String> x = LinkedHashMapFactory.create();
        assertNotNull(x);
    }

    ////////////////////////////////////////////////////////////////////////////////////////////////
    // LinkedHashMapFactory.builder()
    //

    @Test
    public void newInstance_Pass() {
        LinkedHashMapBuilder<String, Integer> x = classUnderTest.builder();
        assertNotNull(x);
        assertTrue(x.build().isEmpty());
    }

    ////////////////////////////////////////////////////////////////////////////////////////////////
    // LinkedHashMapFactory.copyOf(Class, Class, Object...)
    //
    ...
    public void copyOf1_Pass() {
        ...
        MoreAssertUtils.INSTANCE.assertLinkedMapEquals(map, srcMap);
    }

    ////////////////////////////////////////////////////////////////////////////////////////////////
    // LinkedHashMapFactory.copyOf(Iterable, Iterable)
    //
    ...
    ////////////////////////////////////////////////////////////////////////////////////////////////
    // LinkedHashMapFactory.copyOf(Map.Entry...)
    //
    ...
    ////////////////////////////////////////////////////////////////////////////////////////////////
    // LinkedHashMapFactory.copyOf(Map)
    //

    @Test
    public void copyOf5_Pass() {
        ImmutableMap<String, Integer> srcMap = ImmutableMap.of("abc", 123, "def", 456);
        LinkedHashMap<String, Integer> map = classUnderTest.copyOf(srcMap);
        MoreAssertUtils.INSTANCE.assertLinkedMapEquals(map, srcMap);
    }
