 ...
 */
public class AtLeastCountMatcherTest {
    ...
    public void pass_isMatch(final int min, final int value, final boolean expectedResult) {
        ...
        final AtLeastCountMatcher m = new AtLeastCountMatcher(min);
    ...
    public void pass_hashCode() {
        ...
        Assert.assertEquals(new AtLeastCountMatcher(7).hashCode(), new AtLeastCountMatcher(7).hashCode());
        Assert.assertNotEquals(new AtLeastCountMatcher(6).hashCode(), new AtLeastCountMatcher(7).hashCode());
    }
    ...
    public void pass_equals(final int min, final int min2) {
        ...
        final AtLeastCountMatcher m = new AtLeastCountMatcher(min);
        final AtLeastCountMatcher m2 = new AtLeastCountMatcher(min2);
    ...
    public void pass_toString() {
        ...
        Assert.assertEquals(new AtLeastCountMatcher(7).toString(), "at least 7");
        Assert.assertEquals(new AtLeastCountMatcher(23).toString(), "at least 23");
    }
}
