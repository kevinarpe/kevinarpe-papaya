...
implements SetBuilderFactory<ImmutableSetBuilder<TValue>> {
     ...
     */
    public static <TValue> ImmutableSetBuilderFactory<TValue> create() {
        ImmutableSetBuilderFactory<TValue> x = new ImmutableSetBuilderFactory<TValue>();
        return x;
    }

    private ImmutableSetBuilderFactory() {
        // Empty
    }
