 ...
 */
@FullyTested
public abstract class ForwardingMessageFormatter
implements MessageFormatter {

    protected ForwardingMessageFormatter() {
        // Empty
    }

    protected abstract MessageFormatter
    delegate();
    ...
    format(@EmptyStringAllowed
        ...
        return delegate().format(format, argArr);
    }
}
